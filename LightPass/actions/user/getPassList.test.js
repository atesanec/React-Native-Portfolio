...
import getPassList from './getPassList';
...
describe('getPassList', () => {
  afterEach(() => {
    callSdkMethod.sdk.users.getPassList.mockReset();
  });

  test('handles success', async () => {
    callSdkMethod.sdk.users.getPassList.mockReturnValue(
      Promise.resolve(
        JSON.parse(`[
          {
    ...
    await store.dispatch(getPassList());

    expect(store.getActions()).toMatchInlineSnapshot(`
      Array [
        Object {
          "type": "user/GET_PASS_LIST_REQUEST",
        },
        Object {
          "payload": Array [
            Object {
          ...
          "type": "user/GET_PASS_LIST_SUCCESS",
        },
      ]
    `);
  });
    ...
    expect(store.getActions()).toMatchInlineSnapshot(`
      Array [
        ...
        Object {
          ...
          "type": "user/GET_PASS_LIST_FAILURE",
        },
      ]
    `);
  });

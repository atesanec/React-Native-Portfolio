...
import getPassListIssuedByUser from './getPassListIssuedByUser';
...
describe('getPassListIssuedByUser', () => {
  afterEach(() => {
    callSdkMethod.sdk.users.getPassesIssuedByUser.mockReset();
  });

  test('handles success', async () => {
    callSdkMethod.sdk.users.getPassesIssuedByUser.mockReturnValue(
      Promise.resolve(
        JSON.parse(`[
          {
    ...
    await store.dispatch(getPassListIssuedByUser());

    expect(store.getActions()).toMatchInlineSnapshot(`
      Array [
        Object {
          "type": "user/GET_PASS_LIST_ISSUED_BY_USER_REQUEST",
        },
        Object {
          "payload": Array [
            Object {
          ...
          "type": "user/GET_PASS_LIST_ISSUED_BY_USER_SUCCESS",
        },
      ]
    `);
  });
    ...
    expect(store.getActions()).toMatchInlineSnapshot(`
      Array [
        ...
        Object {
          ...
          "type": "user/GET_PASS_LIST_ISSUED_BY_USER_FAILURE",
        },
      ]
    `);
  });
